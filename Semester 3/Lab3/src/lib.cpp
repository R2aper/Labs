...
PopulationGrowth::PopulationGrowth() : name("Untitled") {
  growth2010 = 0;
  growth2011 = 0;
  growth2012 = 0;
  growth2013 = 0;
...
PopulationGrowth::PopulationGrowth(const string &name, int growth2010, int growth2011,
                                   int growth2012, int growth2013, int growth2014) {
  this->name = name;
...
void PopulationGrowth::Print() {
  cout << name << setw(5) << "\t" << growth2010 << setw(5) << growth2011 << setw(5) << growth2012
       << setw(5) << growth2013 << setw(5) << growth2014 << endl;
}

void PopulationGrowth::setName(const string &name) { this->name = name; }
...
const string &PopulationGrowth::GetName() { return name; }
